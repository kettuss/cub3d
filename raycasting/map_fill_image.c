...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/07 23:34:56 by kpeanuts          #+#    #+#             */
/*   Updated: 2022/03/07 23:34:57 by kpeanuts         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	fill_big_pixel(t_vars img, t_point pnt, int v, int color)
{
	t_point	to_p;
...
void	map_fill_img(t_vars img_map, char **maps)
{
	t_point	point;
